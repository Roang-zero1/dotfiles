# Generated by Powerlevel10k configuration wizard on 2020-04-03 at 02:17 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    my_docker_compose          # show current docker compose container status
  ...
  [[ "$TERM_PROGRAM" == "vscode" ]] && typeset -g POWERLEVEL9K_TERM_SHELL_INTEGRATION=true
